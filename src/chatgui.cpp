    ...
    : wxScrolledWindow(parent, id)
{
    ...
    _chatLogic = std::make_unique<ChatLogic>(); //TASK1 - make _chatLogic a unique pointer
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    //// STUDENT CODE
    ////
    // delete _chatLogic; // TASK1 - now _chatLogic is a unique pointer, no need to delete it
